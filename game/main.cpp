...
int main(int argc, char* args[]) {
    ...
    Player player(100, 100, 50, 50, 1920, 1080); // Initialize player with suitable parameters
    Enemy enemy(renderer, 200, 200);           // Initialize enemy at position (200, 200)
    ...
    while (!quit) {
        ...
        enemy.update(player);             // Update enemy based on player position
